...
use token_launch::{constants::TOKEN_2022_PROGRAM_ID, LaunchConfig, LaunchpadInstruction};

use super::LaunchResult;

pub async fn launch_spl_token_2022(
    program_id: Pubkey,
    ...
    match result {
        Ok(signature) => {
            println!("✅ SPL Token 2022 launched successfully!");
            return Ok(
                LaunchResult {
                    mint: mint.pubkey(),
